...
<style>
  ...
  .page-container {
    ...
    <div class="container flex_centered page-container">
        <form class="modern-form" action="login_process.php" method="POST">
...
<svg fill="none" viewBox="0 0 24 24" class="input-icon"> <path stroke-width="1.5" stroke="currentColor" d="M12 10V14M8 6H16C17.1046 6 18 6.89543 18 8V16C18 17.1046 17.1046 18 16 18H8C6.89543 18 6 17.1046 6 16V8C6 6.89543 6.89543 6 8 6Z" ></path> </svg>
    ...
    <button class="password-toggle" type="button" id="togglePassword" aria-label="Show password">
      <svg id="toggleIcon" fill="none" viewBox="0 0 24 24" class="eye-icon">
        <path
          stroke-width="1.5"
          stroke="currentColor"
  ...
  btn.addEventListener('click', () => {
    if (pwd.type === 'password') {
      ...
      icon.innerHTML = `
        ...
        <path stroke-width="1.5" stroke="currentColor" d="M15 9l-6 6"></path>
      `
