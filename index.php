...
<div class="container top flex_centered mb-5">

<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#reportForm">
  Launch demo modal
</button>
      ...
      <div class="modal-body">
            <form>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="from" value="student@example.com" disabled>
                </div>
                <div class="mb-3">
